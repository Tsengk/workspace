...
POINT_CLOUD_REGISTER_POINT_STRUCT(avos::perception_calib::pcl_util::PointD,
                                  (double, x, x)
                                  (double, y, y)
                                  (double, z, z)
                                  (uint8_t, intensity, intensity))

POINT_CLOUD_REGISTER_POINT_STRUCT(avos::perception_calib::pcl_util::PointXYZIH,
                                  (float, x, x)
                                  (float, y, y)
                                  (float, z, z)
...
POINT_CLOUD_REGISTER_POINT_STRUCT(avos::perception_calib::pcl_util::PointXYZIT,
                                  (float, x, x)
                                  (float, y, y)
                                  (float, z, z)
                                  (uint8_t, intensity, intensity)
                                  (double, timestamp, timestamp))
POINT_CLOUD_REGISTER_POINT_STRUCT(avos::perception_calib::pcl_util::RawPointXYZIT,
                                  (float, x, x)
                                  (float, y, y)
                                  (float, z, z)
                                  (uint8_t, intensity, intensity)
...
POINT_CLOUD_REGISTER_POINT_STRUCT(avos::perception_calib::pcl_util::PointXYZIRT,
                                  (float, x, x)
                                  (float, y, y)
                                  (float, z, z)
                                  (uint8_t, intensity, intensity)
...
POINT_CLOUD_REGISTER_POINT_STRUCT(avos::perception_calib::pcl_util::PointXYZIART,
                                  (float, x, x)
                                  (float, y, y)
                                  (float, z, z)
                                  (uint8_t, intensity, intensity)
...
POINT_CLOUD_REGISTER_POINT_STRUCT(avos::perception_calib::pcl_util::PointXYZITd,
                                  (double, x, x)
                                  (double, y, y)
                                  (double, z, z)
                                  (uint8_t, intensity, intensity)
...
POINT_CLOUD_REGISTER_POINT_STRUCT(avos::perception_calib::pcl_util::PointXYZIRTd,
                                  (double, x, x)
                                  (double, y, y)
                                  (double, z, z)
                                  (uint8_t, intensity, intensity)
...
POINT_CLOUD_REGISTER_POINT_STRUCT(avos::perception_calib::pcl_util::PointXYZRGBRCG,
                                  (float, x, x)
                                  (float, y, y)
                                  (float, z, z)
                                  (float, rgb, rgb)
